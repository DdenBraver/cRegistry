...
Import-LocalizedData LocalizedData -filename cRegistry.strings.psd1
...
{    
    ...
    $keyInfo = Get-Item -Path $Key -ErrorAction SilentlyContinue
...
{    
    ...
    # Create the Regkey
    $retVal = New-Item -Path $Key 2>&1

    # Report any errors
    if ($retVal -and $retVal.GetType().Name -ieq "ErrorRecord")
    {
         throw $retVal
    }
